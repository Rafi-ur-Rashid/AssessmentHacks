	...
	<div class="containter-fluid ">
		<div class="row mt-2 mb-2">
			<div class="card col-5 offset-lg-4 hero-card" style="background-color: #6f1f3a; color: #ffffff;">
				<h2 class="text-light display-4 d-flex justify-content-center fs-1">Examinee Registration</h2>
				<hr>
				...
				<form action="" method="POST" enctype="multipart/form-data" class="form-group">
					...
					<br><br>
					<p><a href="student_login.php" style="color:#ffffff;">Want to go back login page?</a></p>
				</form>
