...
</head><body style="background-color: #6f1f3a ;color: #ffffff; font-family: 'Times New Roman', serif;">
...
{
	$n_id = $_GET['notf'];
	$result=mysqli_query($link,"update msg_tbl_f set read_n='0' where id='$n_id'");
