...
<html>
<head>
    <title>Examiner's Message Portal</title>
    ...
    if (isset($_POST['msg']) && !empty($_POST['msg'])){
        $msg=$_POST['msg'];
            if (empty($msg)){
                ...
                $inserted_rows = mysqli_query( $connect,"INSERT INTO msg_tbl_f (rec_id,message) VALUES ($id,'$msg')")
...
?>
                 <form action="" method="post">
                    <table class="form">                    
                     ...
                     <pre><button ><a href="yourmessage.php" style="text-decoration: none;">See your messages</a></button>   <button><a href="examineesmessage.php" style="text-decoration: none;">See examinees messages</a></button></pre>
                    </form>
