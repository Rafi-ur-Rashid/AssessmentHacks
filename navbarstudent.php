  ...
  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
    ...
    <li class="nav-item">
      <a class="nav-link fs-4 w3-bar-item w3-button w3-hover-none w3-border-white w3-bottombar w3-hover-border-black" href="enrolledexam.php" style=" font-size: 2rem;color:#000000;">Enroll Exam</a>
        ...
        <li class="nav-item">
      <a class="nav-link fs-4 w3-bar-item w3-button w3-hover-none w3-border-white w3-bottombar w3-hover-border-black" href="faculty_list.php" style=" font-size: 2rem;color:#000000;">Faculty List</a>
    </li>
...
<div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    ?>
        ...
        ?>
        <li class="alert-info"><a style="text-decoration: none;"href="?notf=<?php echo $value['id'];?>"><?php echo $value['title'];?></a></li>
        <?php

          }else{
        ?>
         <li><a href="indexn.php" style="text-decoration: none;"><?php echo $value['title'];?></a></li>
        <?php
        }
       }
        ?>
...
<?php
  ...
  $data = mysqli_query($link,"select * from msg_tbl_f");
  $new_data = mysqli_query($link,"select * from msg_tbl_f where read_n=1");
  $count = mysqli_num_rows( $new_data );
